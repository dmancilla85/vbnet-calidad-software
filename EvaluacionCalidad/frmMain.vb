Public Class FrmMain
    ...
    Private ReadOnly dFuncAdFuncional As Double
    Private ReadOnly dFuncPrecision As Double

    Private ReadOnly dUsabEntendible As Double
    Private ReadOnly dUsabAprendizaje As Double
    Private ReadOnly dUsabCapOper As Double
    Private ReadOnly dUsabAtractivo As Double

    Private ReadOnly dMantAnalizable As Double
    Private ReadOnly dMantModificable As Double

    Private ReadOnly dPortInstalable As Double
    Private ReadOnly dPortCoexistencia As Double
    Private ReadOnly dPortReemplazable As Double

    Private ReadOnly dFiabMadurez As Double
    Private ReadOnly dFiabRecuperable As Double

    Private ReadOnly dEficComportamiento As Double
    Private ReadOnly dEficRecursos As Double
                ...
                Case Estado.Funcionalidad + 1
                   ...
                   mskPrecTotal.Text = "" Then
                    ...
                    If Integer.Parse(mskPrecOk.Text) > Integer.Parse(mskPrecTotal.Text) Then
                        MsgBox("Casos totales debe ser mayor o igual que casos exitosos.",
